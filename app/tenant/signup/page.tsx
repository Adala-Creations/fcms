      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="mt-1 relative">
            ...
            <Input id="email" name="email" type="email" autoComplete="email" required className="pl-10" placeholder="tenant@fcms.com" value={formData.email} onChange={handleInputChange} />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-1">
            <Input id="phone" name="phone" type="tel" autoComplete="tel" required placeholder="+263 77 123 4567" value={formData.phone} onChange={handleInputChange} />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div>
            ...
            <div className="mt-1 relative">
              ...
              <Input id="unitNumber" name="unitNumber" type="text" required className="pl-10" placeholder="A-12" value={formData.unitNumber} onChange={handleInputChange} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-1 relative">
              ...
              <Input id="landlordEmail" name="landlordEmail" type="email" required className="pl-10" placeholder="landlord@fcms.com" value={formData.landlordEmail} onChange={handleInputChange} />
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-1 relative">
            ...
            <Input id="password" name="password" type={showPassword ? 'text' : 'password'} autoComplete="new-password" required className="pl-10 pr-10" placeholder="Create a strong password" value={formData.password} onChange={handleInputChange} />
        ...
        <div>
          ...
          <div className="mt-1 relative">
            ...
            <Input id="confirmPassword" name="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} autoComplete="new-password" required className="pl-10 pr-10" placeholder="Confirm your password" value={formData.confirmPassword} onChange={handleInputChange} />
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/tenant/signin" className="font-medium text-primary-600 hover:text-primary-500">Sign in here</Link>
          </p>
        </div>
      </form>
    </AuthLayout>
