  ...
  return (
    <div>
      <Header 
        ...
        subtitle="Manage your security personnel account settings"
      />
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="border-t pt-4">
                <h4 className="text-sm font-medium text-gray-900 mb-3">Security Notifications</h4>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="shiftAlerts">Shift Alerts</Label>
                      <p className="text-sm text-gray-500">Get notified about shift changes and schedules</p>
                    </div>
                    <input
                      id="shiftAlerts"
                      name="shiftAlerts"
                      type="checkbox"
                      checked={notificationSettings.shiftAlerts}
                      onChange={handleNotificationChange}
                      className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                    />
                  </div>
