  ...
  return (
    <div>
      <Header 
        ...
        subtitle="Manage your property owner account settings"
      />
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="border-t pt-4">
                <h4 className="text-sm font-medium text-gray-900 mb-3">Property Notifications</h4>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="rentAlerts">Rent Alerts</Label>
                    ...
                    <input
                      ...
                      name="rentAlerts"
                      type="checkbox"
                      checked={notificationSettings.rentAlerts}
                      onChange={handleNotificationChange}
                      className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Get notified about tenant activities</p>
                    </div>
                    <input
                      id="tenantAlerts"
                      name="tenantAlerts"
