...
export default function ProviderSignIn() {
  ...
  return (
    <AuthLayout title="Service Provider Sign In" subtitle="Access your service provider portal" role="service-provider">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="mt-1 relative">
            ...
            <Input id="email" name="email" type="email" autoComplete="email" required className="pl-10" placeholder="provider@fcms.com" value={formData.email} onChange={handleInputChange} />
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm">
            <Link href="/provider/forgot-password" className="font-medium text-primary-600 hover:text-primary-500">Forgot password?</Link>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">Don't have an account? <Link href="/provider/signup" className="font-medium text-primary-600 hover:text-primary-500">Sign up here</Link></p>
        </div>
      </form>
    </AuthLayout>
  )
